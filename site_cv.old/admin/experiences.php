...
if($_POST){
	...
	$resultat = $pdo -> prepare("INSERT INTO experiences(id_experience,titre_exp,sous_titre_exp,dates,description,id_competence) VALUES(:id_experience,:titre_exp,:sous_titre_exp,:dates,:description,:id_competence)");
	}
	else{
		$resultat = $pdo -> prepare("REPLACE INTO experiences(id_experience,titre_exp,sous_titre_exp,dates,description,id_competence) VALUES(:id_experience,:titre_exp,:sous_titre_exp,:dates,:description,:id_competence)");
...
<div class="conteneur">
	<form class ="form_exp" action="" method="post" enctype="">
		...
		<textarea style="resize:none;margin-top:12px;" type="text" name="description" class="champ_texte" value="<?= $description ?>" col="25" rows="1"></textarea>
